...
set_directive_unroll -factor 10 "HLS::my_ik/LOOP_return"
...
set_directive_array_partition -type complete -dim 1 "HLS::my_ik/LOOP_ITER" JRe
set_directive_array_partition -type block -factor 10 -dim 1 "HLS::my_ik/LOOP_ITER" q_test
set_directive_array_partition -type complete -dim 1 "HLS::my_ik/LOOP_ITER" p_in_LMU
...
set_directive_pipeline -II 100 "HLS::my_ik/LOOP_random_method_JRe"
set_directive_dependence -type inter -dependent false "HLS::my_ik/LOOP_random_method_JRe"
set_directive_unroll -factor 10 "HLS::my_ik/LOOP_random_method_delta_q"
...
set_directive_unroll -factor 10 "HLS::my_ik/LOOP_LM_update"
...
set_directive_dependence -type inter -dependent false "HLS::my_ik/LOOP_JJTe_2_1"
set_directive_dependence -type inter -dependent false "HLS::my_ik/LOOP_JRe_1"
set_directive_dependence -type intra -dependent false "HLS::my_ik/LOOP_JRe_2"
set_directive_dependence -type inter -dependent false "HLS::my_ik/LOOP_JRe_2_1"
set_directive_dependence -type inter -dependent false "HLS::my_ik/LOOP_LM_init_1"
set_directive_dependence -type intra -dependent false "HLS::my_ik/LOOP_LM_init_1"
set_directive_dependence -type inter -dependent false "HLS::my_ik/LOOP_LM_init_2"
set_directive_dependence -type intra -dependent false "HLS::my_ik/LOOP_LM_init_2"
set_directive_array_partition -type block -factor 6 -dim 1 "HLS::my_ik/LOOP_ITER" Jac
