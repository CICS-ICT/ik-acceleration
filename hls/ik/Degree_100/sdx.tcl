# ==============================================================
# File generated on Wed Aug 14 18:15:12 CST 2019
...
set_directive_unroll HLS::my_ik/LOOP_init -factor 10
...
set_directive_unroll HLS::my_ik/LOOP_return -factor 10
...
set_directive_array_partition HLS::my_ik/LOOP_ITER 
set_directive_array_partition HLS::my_ik/LOOP_ITER 
set_directive_pipeline HLS::my_ik/LOOP_random_method_JRe -II 100
set_directive_dependence HLS::my_ik/LOOP_random_method_JRe 
set_directive_unroll HLS::my_ik/LOOP_random_method_delta_q -factor 10
set_directive_dependence HLS::my_ik/LOOP_random_method_delta_q 
set_directive_dependence HLS::my_ik/LOOP_random_method_delta_q 
set_directive_pipeline HLS::my_ik/LOOP_LM_init -II 51
...
set_directive_unroll HLS::my_ik/LOOP_LM_update -factor 10
