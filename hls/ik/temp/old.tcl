...
set_directive_pipeline "HLS::my_jac_solver/LOOP_my_jac_solver"
...
set_directive_pipeline "HLS::my_ik/LOOP_JJTe_2"
...
set_directive_pipeline "HLS::my_fk_solver/LOOP_my_fk_solver"
...
set_directive_array_partition -type block -factor 10 -dim 1 "HLS::my_ik/LOOP_ITER" f_LMU
set_directive_array_partition -type block -factor 10 -dim 1 "HLS::my_ik/LOOP_ITER" e_LMU
...
set_directive_pipeline "HLS::my_ik/LOOP_random_method_delta_q"
set_directive_pipeline "HLS::my_ik/LOOP_LM_init"
...
set_directive_pipeline "HLS::my_ik/LOOP_LM_update"
